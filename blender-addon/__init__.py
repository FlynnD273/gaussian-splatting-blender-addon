...
class ImportGaussianSplatting(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        colorramp_node = mat_tree.nodes.new('ShaderNodeValToRGB')
        colorramp_node.color_ramp.interpolation = "EASE"
        ...
        mat_tree.links.new(
            ...
            colorramp_node.inputs[0]
        )

        mat_tree.links.new(
            colorramp_node.outputs["Color"],
            math_node.inputs[1]
        )
        ...
        tetra_node = geo_tree.nodes.new('GeometryNodeMeshCone')
        tetra_node.location = (200, 200)
        tetra_node.inputs["Vertices"].default_value = 3
        tetra_node.inputs["Depth"].default_value = 1.41
        ...
        scale_node.inputs["Scale"].default_value = 4
